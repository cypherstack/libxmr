#include "include/libxmr/libxmr_plugin.h"
...
static void libxmr_plugin_dispose(GObject* object) {
  G_OBJECT_CLASS(libxmr_plugin_parent_class)->dispose(object);
}

static void libxmr_plugin_class_init(LibXmrPluginClass* klass) {
  G_OBJECT_CLASS(klass)->dispose = libxmr_plugin_dispose;
}

static void libxmr_plugin_init(LibXmrPlugin* self) {}
